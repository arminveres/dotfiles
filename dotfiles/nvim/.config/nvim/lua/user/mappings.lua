...
keymap('n', '<leader><space>', function() require('telescope.builtin').buffers() end, opts)
keymap('n', '<leader>ff', function() require('telescope.builtin').find_files() end, opts)
keymap('n', '<leader>sb', function() require('telescope.builtin').current_buffer_fuzzy_find() end, opts)
keymap('n', '<leader>sh', function() require('telescope.builtin').help_tags() end, opts)
keymap('n', '<leader>sd', function() require('telescope.builtin').grep_string() end, opts)
keymap('n', '<leader>sp', function() require('telescope.builtin').live_grep() end, opts)
keymap('n', '<leader>cd', function() require("telescope").extensions.zoxide.list() end, opts)
