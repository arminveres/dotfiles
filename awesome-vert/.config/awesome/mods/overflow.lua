...
function overflow:layout(context, orig_width, orig_height)
    ...
    if need_scrollbar then
        ...
        if is_y then
            bar_w, bar_h =
                base.fit_widget(self, context, scrollbar_widget, scrollbar_width, bar_length)
            bar_y = bar_pos
            ...
            bar_w, bar_h =
                base.fit_widget(self, context, scrollbar_widget, bar_length, scrollbar_width)
            bar_x = bar_pos
        ...
        if is_in_view then
            ...
            table.insert(
                ...
                base.place_widget_at(
                    ...
                    math.floor(
                        need_scrollbar and content_w - self._private.scrollbar_spacing or content_w
                    ),
